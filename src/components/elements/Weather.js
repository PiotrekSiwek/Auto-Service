...
const Weather = () => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_URL}q=Radzymin&units=metric&appid=${process.env.REACT_APP_API_KEY}`)
    ...
    return (
        ...
        <div className="weather">
            ...
            <div className="weather__box">
                ...
                <p className="weather__temp"> Temperatura odczuwalna: {Math.floor(weather.main.feels_like)} &deg; C </p>
